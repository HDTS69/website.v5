    ...
    emergencyServices: [
      {
        ...
        description: "Round-the-clock emergency plumbing services for Brisbane residents",
    ...
    services: [
        ...
        items: [
          {
            ...
            description: "Installation, repair, and maintenance of all hot water system types",
      ...
      },
      {
        ...
        items: [
          {
            title: "Gas Fitting",
            description: "Licensed gas fitting services for homes and businesses",
