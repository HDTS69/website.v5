...
import { BrandPageLayout } from '@/src/components/layouts/BrandPageLayout'
...
const features = [
  {
    ...
    description:
      'Proudly manufactured in Australia to meet local conditions and standards.',
    icon: <Shield className="h-6 w-6 text-[#00E6CA]" />,
  },
  {
    title: 'Energy Efficient',
    description:
      'High energy rating systems that help reduce your power bills.',
    icon: <Wrench className="h-6 w-6 text-[#00E6CA]" />,
  },
  {
    title: 'Long Warranty',
    description:
      'Up to 10-year warranty on tanks and components for peace of mind.',
    icon: <Clock className="h-6 w-6 text-[#00E6CA]" />,
  },
  {
...
const testimonials = [
  {
    content:
      'Exceptional service! The team was professional, punctual, and solved our hot water issues quickly.',
    author: 'John Smith',
    location: 'Brisbane',
    rating: 5,
  },
  {
    content:
      "Best plumbing service I've ever used. Fair pricing and excellent workmanship.",
  ...
  {
    content:
      'Highly recommend! They went above and beyond to help us with our emergency repair.',
...
const products = [
  {
    ...
    description:
      'Energy-efficient electric storage systems available in various sizes.',
  ...
  },
  {
    ...
    description:
      'Continuous flow and storage gas systems for instant hot water.',
  ...
  },
  {
    ...
    description:
      'Environmentally friendly heat pump technology for maximum efficiency.',
...
const financeOptions = {
  ...
  description:
    'Make your AquaMAX hot water system more affordable with our range of payment plans.',
  points: [
