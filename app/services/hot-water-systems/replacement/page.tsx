...
export const metadata: Metadata = {
  ...
  description: 'Professional hot water system replacement in Brisbane. Expert advice and installation by licensed plumbers. Quality workmanship guaranteed. Call now!',
};
