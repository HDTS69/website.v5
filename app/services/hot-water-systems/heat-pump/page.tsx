...
export const metadata: Metadata = {
  ...
  description: 'Professional heat pump hot water system installation and service in Brisbane. Energy-efficient solutions, expert installation, and quality guaranteed. Call now!',
};
    ...
    items: [
      ...
      },
      {
        ...
        listItems: [
          ...
          { icon: <FaTools className="text-yellow-400"/>, text: "Efficiency Optimization" }
        ]
      },
      {
