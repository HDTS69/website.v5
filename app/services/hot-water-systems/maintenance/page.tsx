...
export const metadata: Metadata = {
  ...
  description: 'Expert guidance on choosing the right hot water system in Brisbane. Compare system types, costs, and efficiency. Professional advice from licensed plumbers. Call now!',
};
