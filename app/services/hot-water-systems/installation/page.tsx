...
export const metadata: Metadata = {
  ...
  description: 'Expert hot water system installation in Brisbane. All system types installed by licensed plumbers. Professional advice, quality workmanship, and satisfaction guaranteed. Call now!',
};
  ...
  bentoGridData: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "System Types",
        listItems: [
          { icon: <FaTools className="text-blue-400"/>, text: "Electric Systems" },
          { icon: <FaTools className="text-red-400"/>, text: "Gas Systems" },
          { icon: <FaTools className="text-green-400"/>, text: "Solar Systems" },
          { icon: <FaTools className="text-yellow-400"/>, text: "Heat Pump Systems" }
        ]
      },
      {
  ...
  return (
    <>
      ...
      <ServiceSchema 
        ...
        description="Professional hot water system installation services in Brisbane. Our licensed plumbers provide expert installation for all types of hot water systems."
        serviceArea="Brisbane Hot Water Installation Local Business Queensland"
      />
