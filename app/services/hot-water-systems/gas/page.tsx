...
export const metadata: Metadata = {
  ...
  description: 'Professional gas hot water system installation and repairs in Brisbane. Licensed gas fitters, quality workmanship, and satisfaction guaranteed. Call now!',
};
