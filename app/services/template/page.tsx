...
const serviceTemplateData: ServiceDetailLayoutProps = {
  ...
  bentoGridData: {
    ...
    items: [
      ...
      },
      {
        ...
        listItems: [
          { icon: <FaCertificate className="text-blue-400"/>, text: "Thorough Initial Assessment" },
          { icon: <FaTools className="text-green-400"/>, text: "Detailed Action Plan" },
          { icon: <FaThumbsUp className="text-yellow-400"/>, text: "Expert Execution & Cleanup" },
        ],
      },
      {
        type: 'payment',
  ...
  introData: {
    ...
    paragraph1: 
      `Choosing the right provider for your [Service Name] needs is crucial. At HD Trade Services, we understand the importance of <span class="font-bold text-white">reliability and expertise</span>. Our process is designed for <span class="font-bold text-white">maximum efficiency</span> and minimal disruption to your routine, ensuring a smooth experience from the initial consultation to project completion.`,
    paragraph2:
      `We leverage <span class="font-bold text-white">cutting-edge technology</span> and proven techniques to deliver superior [Service Name] outcomes. Whether it's a minor fix or a major installation, our team operates with <span class="font-bold text-white">precision and care</span>, treating your property with the respect it deserves. Trust us to get the job done right, <span class="font-bold text-white">the first time</span>.`
