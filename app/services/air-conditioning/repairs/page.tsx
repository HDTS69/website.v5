    ...
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          <h1 className="standard-header">Air Conditioning Repairs</h1>
          <p className="standard-subheader">
            Expert repair services for all air conditioning systems. Fast,
            reliable solutions to get your AC working efficiently again.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 p-8 shadow-lg">
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  Our experienced technicians can diagnose and repair all common
                  air conditioning issues, including:
                </p>
                ...
                <p className="mt-4">
                  We service all major brands and models of air conditioning
                  systems, providing fast and effective repairs to restore
