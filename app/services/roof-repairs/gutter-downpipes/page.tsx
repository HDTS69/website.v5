    ...
    <>
      ...
      <ServiceDetailLayout
          ...
          items: [
            {
              ...
              description: "Our experienced team delivers high-quality gutter and downpipe services.",
            ...
            },
            {
              ...
              description: "We use state-of-the-art equipment and proven methods for optimal results.",
        ...
        issuesData={{
          ...
          introParagraph: "We provide professional services for all gutter and downpipe needs.",
          issues: [
            {
              title: "Installation",
