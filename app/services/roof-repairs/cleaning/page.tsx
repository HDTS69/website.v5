    ...
    <>
      ...
      <ServiceDetailLayout
          ...
          items: [
            {
              ...
              description:
                'Our experienced team delivers high-quality roof cleaning services with attention to detail and safety.',
            },
            {
              type: 'standard',
              ...
              description:
                'We use professional-grade equipment and cleaning solutions for optimal results.',
            },
            {
              type: 'standard',
              ...
              description:
                'Comprehensive roof cleaning services for all types of roofs and materials.',
            },
            {
              type: 'list',
              title: 'Our Services',
              listItems: [
                ...
                },
                {
                  ...
                  text: 'Chemical Cleaning',
                },
                {
                  icon: <FaTools className="text-green-400" />,
                  text: 'Maintenance Cleaning',
                },
                {
        ...
        introData={{
          ...
          paragraph1:
            "We provide comprehensive roof cleaning services to maintain your roof's condition and extend its lifespan.",
          paragraph2:
            'Our team uses professional equipment and safe cleaning methods to ensure the best results.',
        }}
        issuesData={{
          title: 'Our Roof Cleaning Services',
          subtitle: 'Professional Solutions',
          introParagraph:
            'We offer a range of professional roof cleaning services to meet your needs:',
          issues: [
            {
        ...
        financeData={{
          ...
          description1:
            'We offer competitive rates for our professional roof cleaning services.',
          description2:
        ...
        ctaData={{
          ...
          description:
            'Contact us today to schedule your professional roof cleaning service.',
