    ...
    <>
      ...
      <ServiceDetailLayout
        ...
        bentoGridData={{
          ...
          items: [
            ...
            },
            {
              ...
              listItems: [
                { icon: <FaTools className="text-blue-400"/>, text: "Full Roof Assessment" },
                { icon: <FaTools className="text-red-400"/>, text: "Leak Detection" },
                { icon: <FaTools className="text-green-400"/>, text: "Damage Inspection" },
                { icon: <FaTools className="text-yellow-400"/>, text: "Detailed Reports" }
              ]
            },
            {
        ...
        issuesData={{
          ...
          introParagraph: "We provide professional services for all roof inspection needs.",
          issues: [
            {
