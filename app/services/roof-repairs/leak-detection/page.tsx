    ...
    <>
      ...
      <ServiceDetailLayout
          ...
          items: [
            {
              ...
              description: 'Our experienced team delivers high-quality leak detection with advanced technology and expertise.'
            },
            {
              type: 'standard',
              title: 'Quality Service',
              icon: '/icons/graduation-scroll.json',
              description: 'We use state-of-the-art detection equipment and proven methods for accurate results.'
            },
            {
              type: 'standard',
              title: 'Detection Services',
              icon: '/icons/magnifier-zoom.json',
              description: 'Comprehensive leak detection services for all types of roof issues.'
            },
            {
              type: 'list',
              title: 'Our Services',
              listItems: [
                { icon: <FaTools className="text-blue-400"/>, text: "Thermal Imaging" },
                { icon: <FaTools className="text-red-400"/>, text: "Moisture Detection" },
                { icon: <FaTools className="text-green-400"/>, text: "Visual Inspection" },
                { icon: <FaTools className="text-yellow-400"/>, text: "Water Testing" }
              ]
            },
            {
              type: 'payment',
        ...
        issuesData={{
          ...
          introParagraph: 'We offer comprehensive leak detection services using advanced technology:',
          issues: [
            {
