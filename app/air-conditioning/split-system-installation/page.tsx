...
export const metadata: Metadata = {
  title: 'Split System Air Conditioning Installation Brisbane | HD Trade Services',
  description: 'Professional split system air conditioning installation in Brisbane. Expert technicians, competitive pricing, and guaranteed workmanship. Book online or call now!',
};
    ...
    bentoGridData: {
      ...
      items: [
        ...
        },
        {
          ...
          listItems: [
            { icon: <FaCheckCircle className="text-blue-400"/>, text: "Site Assessment & Consultation" },
            { icon: <FaCheckCircle className="text-green-400"/>, text: "Professional Installation" },
            { icon: <FaCheckCircle className="text-yellow-400"/>, text: "System Testing & Optimization" },
            { icon: <FaCheckCircle className="text-red-400"/>, text: "Warranty Registration" }
          ]
        },
        {
