...
export const metadata: Metadata = {
  ...
  description: 'Expert air conditioning cleaning in Brisbane. Professional deep cleaning, sanitization, and maintenance for optimal AC performance. Book your cleaning service today!',
};
    ...
    bentoGridData: {
      ...
      items: [
        ...
        },
        {
          ...
          listItems: [
            { icon: <FaCheckCircle className="text-blue-400"/>, text: "Deep Coil Cleaning" },
            { icon: <FaCheckCircle className="text-green-400"/>, text: "Filter Decontamination" },
            { icon: <FaCheckCircle className="text-yellow-400"/>, text: "Drain Line Clearing" },
            { icon: <FaCheckCircle className="text-red-400"/>, text: "Full System Sanitization" }
          ]
        },
        {
