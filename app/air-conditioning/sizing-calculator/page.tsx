...
export const metadata: Metadata = {
  ...
  description: 'Professional air conditioning sizing service in Brisbane. Expert calculations, room assessment, and perfect size recommendations. Book your sizing consultation today!',
};
    ...
    bentoGridData: {
      ...
      items: [
        ...
        },
        {
          ...
          title: "Our Process",
          listItems: [
            { icon: <FaCheckCircle className="text-blue-400"/>, text: "Space Assessment" },
            { icon: <FaCheckCircle className="text-green-400"/>, text: "Load Calculations" },
            { icon: <FaCheckCircle className="text-yellow-400"/>, text: "System Recommendations" },
            { icon: <FaCheckCircle className="text-red-400"/>, text: "Detailed Report" }
          ]
        },
        {
