    ...
    bentoGridData: {
      ...
      items: [
        ...
        },
        {
          ...
          listItems: [
            { icon: <FaCheckCircle className="text-blue-400"/>, text: "System Performance Analysis" },
            { icon: <FaCheckCircle className="text-green-400"/>, text: "Electrical Testing" },
            { icon: <FaCheckCircle className="text-yellow-400"/>, text: "Component Inspection" },
            { icon: <FaCheckCircle className="text-red-400"/>, text: "Refrigerant Level Check" }
          ]
        },
        {
