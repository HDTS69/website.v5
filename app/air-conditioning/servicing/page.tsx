    ...
    bentoGridData: {
      ...
      items: [
        ...
        },
        {
          ...
          listItems: [
            { icon: <FaCheckCircle className="text-blue-400"/>, text: "Filter Cleaning & Replacement" },
            { icon: <FaCheckCircle className="text-green-400"/>, text: "Coil Cleaning & Sanitization" },
            { icon: <FaCheckCircle className="text-yellow-400"/>, text: "System Performance Check" },
            { icon: <FaCheckCircle className="text-red-400"/>, text: "Electrical Safety Inspection" }
          ]
        },
        {
