...
export const metadata: Metadata = {
  ...
  description:
    'Professional air conditioning services in Brisbane. Expert installation, repairs, and maintenance for all AC types. Book your service today!',
}
          ...
          listItems: [
            {
              ...
              text: (
                <Link
                  ...
                  className="transition-colors hover:text-[#00E6CA]"
                >
