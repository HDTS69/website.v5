    ...
    bentoGridData: {
      ...
      items: [
        ...
        },
        {
          ...
          listItems: [
            { icon: <FaCheckCircle className="text-blue-400"/>, text: "Cooling Performance Issues" },
            { icon: <FaCheckCircle className="text-green-400"/>, text: "Strange Noises & Vibrations" },
            { icon: <FaCheckCircle className="text-yellow-400"/>, text: "Water Leaks & Drainage" },
            { icon: <FaCheckCircle className="text-red-400"/>, text: "Electrical Problems" }
          ]
        },
        {
