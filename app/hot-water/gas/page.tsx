...
export const metadata: Metadata = {
  ...
  description: 'Professional gas hot water system installation and servicing in Brisbane. Licensed gas fitters, same-day service, and guaranteed workmanship. Call now!',
};
...
const pageData: ServiceDetailLayoutProps = {
    ...
    items: [
      {
        ...
        description: `We're here when you need us most. Our team offers <span class="font-bold text-white">round-the-clock emergency gas hot water service</span> to handle urgent issues <span class="font-bold text-white">anytime, day or night</span>.`,
      ...
      },
      {
        ...
        description: `All work completed by <span class="font-bold text-white">fully licensed and insured gas fitters</span> for your peace of mind.`,
  ...
  introData: {
    title: "Gas Hot Water",
    subtitle: "Experts",
    paragraph1: `Our team specializes in providing <span class="font-bold text-white">comprehensive gas hot water solutions</span>. We handle both continuous flow and storage systems with <span class="font-bold text-white">expertise and precision</span>.`,
    ...
    issues: [
      {
        ...
        description: `Professional installation of <span class="font-bold text-white">continuous flow and storage gas systems</span>.`,
        bullets: [
