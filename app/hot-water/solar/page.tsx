...
export const metadata: Metadata = {
  ...
  description: 'Professional solar hot water system installation and service in Brisbane. Eco-friendly solutions, expert technicians, and competitive pricing. Call now!',
};
