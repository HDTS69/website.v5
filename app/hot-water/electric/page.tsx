...
export const metadata: Metadata = {
  ...
  description: 'Professional electric hot water system installation, repairs and servicing in Brisbane. Expert technicians, same-day service, and competitive pricing. Call now!',
};
