...
export const metadata: Metadata = {
  ...
  description: 'Expert hot water system installation in Brisbane. All system types, professional service, upfront pricing. Licensed technicians and quality guarantees.',
};
  ...
  bentoGridData: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Our Services",
        listItems: [
          { icon: <FaTools className="text-blue-400"/>, text: "New System Installation" },
          { icon: <FaTools className="text-red-400"/>, text: "System Upgrades" },
          { icon: <FaTools className="text-green-400"/>, text: "Compliance Checks" },
          { icon: <FaTools className="text-yellow-400"/>, text: "System Setup" }
        ]
      },
      {
