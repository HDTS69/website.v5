...
export const metadata: Metadata = {
  ...
  description: 'Expert hot water repairs in Brisbane. Fast response, all system types, 24/7 emergency service. Licensed technicians and upfront pricing. Call now!',
};
  ...
  bentoGridData: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Our Services",
        listItems: [
          { icon: <FaTools className="text-blue-400"/>, text: "Emergency Repairs" },
          { icon: <FaTools className="text-red-400"/>, text: "System Diagnostics" },
          { icon: <FaTools className="text-green-400"/>, text: "Parts Replacement" },
          { icon: <FaTools className="text-yellow-400"/>, text: "Preventive Maintenance" }
        ]
      },
      {
