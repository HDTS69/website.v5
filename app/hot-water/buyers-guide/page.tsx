...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive hot water system buyers guide for Brisbane homes. Expert advice on system types, sizing, and installation. Make an informed choice with our professional guidance.',
};
  ...
  bentoGridData: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Our Services",
        listItems: [
          { icon: <FaTools className="text-blue-400"/>, text: "System Comparison" },
          { icon: <FaTools className="text-red-400"/>, text: "Size Calculation" },
          { icon: <FaTools className="text-green-400"/>, text: "Cost Analysis" },
          { icon: <FaTools className="text-yellow-400"/>, text: "Installation Advice" }
        ]
      },
      {
