        ...
        <ServiceDetailLayout
          heroData={{
            ...
            description: {
              ...
              highlights: ["Professional hot water system replacement", "efficient and reliable installation"]
            },
            bookOnlineLink: "#book",
            ...
            items: [
              {
                ...
                description: 'Our experienced team delivers high-quality hot water system replacements with attention to detail.'
              },
              {
                type: 'standard',
                title: 'Quality Assurance',
                icon: ICON_PATHS.STAR_SMILE,
                description: 'We use only the best quality systems and parts for lasting performance.'
              },
              {
                type: 'standard',
          ...
          introData={{
            ...
            paragraph1: "Our team specializes in providing comprehensive hot water system replacement solutions. We handle all system types including gas, electric, solar, and heat pump systems with expertise and precision.",
            paragraph2: "From system selection to professional installation, we ensure your hot water needs are met with reliable and energy-efficient solutions."
          }}
          trustData={{
            title: 'Why Trust Us',
