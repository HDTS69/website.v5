...
export const metadata: Metadata = {
  ...
  description: 'Professional heat pump hot water system installation and service in Brisbane. Energy-efficient solutions, expert technicians, and competitive pricing. Call now!',
};
    ...
    items: [
      ...
      },
      {
        ...
        listItems: [
          ...
          { icon: <FaTools className="text-green-400"/>, text: "System Upgrades" },
