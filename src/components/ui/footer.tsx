  ...
  return (
    <div>
      <button
        ...
        className="flex w-full items-center gap-1 py-1 text-gray-400 transition-colors hover:text-white"
      >
        <svg
          className="h-4 w-4 flex-shrink-0 text-[#1CD4A7]"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <span className="inline-flex flex-1 items-center text-left">
          Opening Hours{' '}
          <span className="ml-1 text-sm text-[#1CD4A7]">24/7</span>
          <ChevronDown
            className={cn(
      ...
      >
        <div className="overflow-hidden">
          <div className="space-y-2 pb-1 pt-2 text-sm">
            {[
              'Monday',
              'Tuesday',
              'Wednesday',
...
export default function Footer({ showCTA = false }: FooterProps) {
  ...
  const shouldShowCTA =
    showCTA && pathname !== '/careers' && !pathname.includes('/attendance-fee')
  ...
  return (
    <footer className="relative bg-black">
      ...
      {/* CTA Banner Section */}
      {shouldShowCTA && (
        <div className="w-full border-b border-[#00E6CA]/20 px-4 py-12">
      ...
      <div className="container mx-auto px-4 pb-8 pt-16">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-gray-400">
                  <svg
                    className="h-4 w-4 flex-shrink-0 text-[#00E6CA]"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <li className="flex items-center gap-2 text-gray-400">
                  ...
                  <div className="min-w-0 flex-1">
                    <Link
                      href="mailto:admin@hdtradeservices.com.au"
                      className="block truncate transition-colors hover:text-white"
                    >
                      admin@hdtradeservices.com.au
                    </Link>
                  </div>
                  <CopyButton
                    text="admin@hdtradeservices.com.au"
                    type="email"
                  />
                </li>
                <li className="flex items-center gap-2 text-gray-400">
                ...
                <li className="mt-6 space-y-1.5 text-sm text-gray-400">
                  <p className="mb-3 text-[#00E6CA]">Licensed & Certified</p>
                  <div className="flex items-center gap-2">
              ...
              <ul className="space-y-2">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="inline-block text-gray-400 transition-colors hover:text-[#00E6CA]"
                    >
                      {link.name}
                    </Link>
                  </li>
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 pt-6 md:grid-cols-2">
          {/* Social Links */}
          <div className="flex justify-center space-x-4 md:justify-start">
            <Link
              href="https://facebook.com"
              target="_blank"
              className="text-gray-500 hover:text-[#00E6CA]"
            >
