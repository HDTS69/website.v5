  ...
  maps: {
    places: {
      Autocomplete: jest.fn().mockImplementation(() => ({
        addListener: jest.fn(),
        getPlace: jest.fn().mockReturnValue({ formatted_address: '123 Test Street, Sydney NSW 2000' }),
      })),
    },
    event: {
...
describe('Google Places Integration', () => {
  ...
  test('GoogleMapsScript loads the Google Maps API', async () => {
    ...
    render(<GoogleMapsScript onLoadSuccess={mockSuccess} onLoadError={mockError} />);
